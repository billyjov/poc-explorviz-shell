...
import Raycaster from 'visualization/utils/raycaster';
...
import LogoMesh from 'visualization/view-objects/3d/logo-mesh';
import LabelMesh from 'visualization/view-objects/3d/label-mesh';
