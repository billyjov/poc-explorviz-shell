...
import ClazzLabelMesh from 'visualization/view-objects/3d/application/clazz-label-mesh';
import ComponentMesh from 'visualization/view-objects/3d/application/component-mesh';
import ComponentLabelMesh from 'visualization/view-objects/3d/application/component-label-mesh';
